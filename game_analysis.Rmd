...
#### 2.1 top 3 favoriate game genres in global scale
...
ggplot(data=top3genre.global)+
  geom_bar(aes(reorder(Genre, genre.sales), genre.sales,fill = genre.sales), stat = 'identity') + 
  scale_fill_viridis_c() +
  theme_minimal() + 
...
#### 2.2 top 3 favoriate game genres in North America scale
...
#### 2.3 top 3 favoriate game genres in Japan scale
...
#### 2.4 top 3 favoriate game genres in Europe scale
...
Since the data during 2016 and 2020 are limited, we simply don't consider (2016,2020] for this question.

### 5. which publisher makes the best-sale game in certain gerne
